...
// Broadcast exhaust temperature unconditionally (caller controls interval via ESPNOW_TX_MS)
...
// Broadcast fuel level ratio unconditionally (caller controls interval via ESPNOW_TX_MS)
